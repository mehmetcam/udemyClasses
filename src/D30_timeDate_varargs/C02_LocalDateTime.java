...
public class C02_LocalDateTime {
    public static void main(String[] args) {
        ...
        System.out.println(tarihSaat); // 2023-11-30T19:01:26.379459500
        System.out.println(tarihSaat.getDayOfWeek()); //THURSDAY

        /*
        LocalDateTime objesi hem tarihi, hem de zamani bize getirir.
        ANCAKKK tarih ve zamani bizim istedigimiz formatta yazdirmaz
        ...
        System.out.println(tarihSaat.format(istedigimFormat2));// 30 novembre 23 jeudi 07 : 19 PM
