...
public class C07_kullanicidanSayiAlipArrayeEkle {
    ...
    public static void main(String[] args) {
        ...
        // Kullanicidan bir sayi alip arr' ye 4. element olarak ekleyin.

        Scanner scanner = new Scanner(System.in);
        System.out.println("Lutfen eklemek istediginiz sayiyi giriniz");
        int eklenecekSayi = scanner.nextInt();

        C06_ArrayeBirElemanEkleme.arrayeBirElemanEkle(arr, eklenecekSayi);
